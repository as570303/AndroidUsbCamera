...
public class UVCCamera {
	...
	protected int mContrastMin =1;
	protected int mContrastMax = 200;
	protected int mContrastDef = 155;
	...
	protected int mSaturationMin = 1;
	protected int mSaturationMax = 255;
	protected int mSaturationDef = 155;
